...
def parse():
  ...
  parser.add_argument('--slm_db', default='src/display/data/ucsd_slm250.db', help='please input ucsd_slm path')
  parser.add_argument('--dunn_db', default='src/display/data/dunn.db', help='please input dunn path')
  try:
